...
while True:
	...
	def psh():
		clear()
		print("Copyright (C) Roccohimel - Pyn Based Systems")
		print("PSH version 0.9 DO NOT DISTRIBUTE")
		print("Type 'exit' to return to Pycal-A menu")
		while True:
			pmt = input("psh> ")
			subprocess.run(pshpmt, shell=True)
			if pmt == "sconfig":
				print("The operation could not be completed. -F000000")
			if pmt == "viewfunc":
				print("The operation could not be completed. -F000000")
			if pmt == "exit":
				startpmt()
